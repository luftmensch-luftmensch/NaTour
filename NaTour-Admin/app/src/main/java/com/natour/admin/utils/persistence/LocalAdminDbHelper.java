...
public class LocalAdminDbHelper extends SQLiteOpenHelper {
    public static final int DATABASE_VERSION = 1;
    public static final String DATABASE_NAME = "AdminUser.DB";
    ...
    */
    ...
    private static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + " (" + _ID + " INTEGER PRIMARY KEY UNIQUE, "
            + USERNAME + " TEXT NOT NULL, " + URL + " TEXT NOT NULL);";

    private static final String DELETE_TABLE =
            "DROP TABLE IF EXISTS " + TABLE_NAME;

    // Costruttore
    public LocalAdminDbHelper(Context context) {
